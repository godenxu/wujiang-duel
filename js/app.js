...
(() => {
  ...
  const APP_VERSION = "202608290720";   // 发版时的 UTC+8 时间戳（YYYYMMDD+HHMM），与 sw.js 缓存版本同步生成
   ...
   * ============================================================ */
  const CITIES = [
    { id: "chengdu", n: "成都", side: "cn", x: 17.64, y: 52.68 },
    { id: "hanzhong", n: "汉中", side: "cn", x: 23.84, y: 41.64 },
    { id: "chang_an", n: "长安", side: "cn", x: 27.89, y: 36.12 },
    { id: "luoyang", n: "洛阳", side: "cn", x: 35.23, y: 34.37 },
    { id: "xuchang", n: "许昌", side: "cn", x: 38.16, y: 37.27 },
    { id: "ye", n: "邺城", side: "cn", x: 39.78, y: 26.64 },
    { id: "xuzhou", n: "徐州", side: "cn", x: 45.36, y: 36.44 },
    { id: "jingzhou", n: "荆州", side: "cn", x: 34.58, y: 46.47 },
    { id: "chaisang", n: "柴桑", side: "cn", x: 42.67, y: 57.14 },
    { id: "jianye", n: "建业", side: "cn", x: 48.54, y: 46.28 },
    { id: "tianshui", n: "天水", side: "cn", x: 21.11, y: 34.69 },
    { id: "baidicheng", n: "白帝城", side: "cn", x: 29.11, y: 50.98 },
    { id: "shangyong", n: "上庸", side: "cn", x: 30.51, y: 45.78 },
    { id: "jiangling", n: "江陵", side: "cn", x: 34.79, y: 54.15 },
    { id: "wancheng", n: "宛城", side: "cn", x: 35.4, y: 42.01 },
    { id: "runan", n: "汝南", side: "cn", x: 39.25, y: 41.91 },
    { id: "xiapi", n: "下邳", side: "cn", x: 46.76, y: 35.89 },
    { id: "shouchun", n: "寿春", side: "cn", x: 44.31, y: 43.89 },
    { id: "hefei", n: "合肥", side: "cn", x: 45.25, y: 47.39 },
    { id: "wuchang", n: "武昌", side: "cn", x: 40.34, y: 53.92 },
    { id: "tsushima", n: "对马岛", side: "sea", x: 70.54, y: 36.44 },
    { id: "satsuma", n: "萨摩", side: "jp", x: 73.2, y: 48.4 },
    { id: "aki", n: "安艺", side: "jp", x: 77.19, y: 35.57 },
    { id: "kyoto", n: "京都", side: "jp", x: 84.13, y: 32.71 },
    { id: "osaka", n: "大坂", side: "jp", x: 83.56, y: 34.19 },
    { id: "owari", n: "尾张", side: "jp", x: 86.52, y: 31.93 },
    { id: "kai", n: "甲斐", side: "jp", x: 90.0, y: 29.72 },
    { id: "sunpu", n: "骏府", side: "jp", x: 89.6, y: 32.85 },
    { id: "odawara", n: "小田原", side: "jp", x: 91.21, y: 31.56 },
    { id: "echigo", n: "越后", side: "jp", x: 90.98, y: 19.33 },
    { id: "oushu", n: "奥州", side: "jp", x: 94.82, y: 17.72 },
    { id: "higo", n: "肥后", side: "jp", x: 73.58, y: 42.93 },
    { id: "bungo", n: "丰后", side: "jp", x: 75.4, y: 40.86 },
    { id: "izumo", n: "出云", side: "jp", x: 77.79, y: 31.06 },
    { id: "bizen", n: "备前", side: "jp", x: 80.27, y: 34.32 },
    { id: "omi", n: "近江", side: "jp", x: 84.34, y: 32.76 },
    { id: "echizen", n: "越前", side: "jp", x: 85.07, y: 27.88 },
    { id: "kaga", n: "加贺", side: "jp", x: 85.97, y: 25.58 },
    { id: "mino", n: "美浓", side: "jp", x: 86.2, y: 30.83 },
    { id: "mikawa", n: "三河", side: "jp", x: 87.04, y: 32.99 },
    { id: "hitachi", n: "常陆", side: "jp", x: 93.94, y: 26.6 },
  ];
  const ROADS = [
  ...
  // 中日采用同一套等距圆柱投影+统一比例尺换算，再各自按 x/y 独立归一化进 0~100，与下方城池坐标、
  // 既有 viewBox="0 0 100 100" + preserveAspectRatio="none" 的拉伸架构完全对齐，城池点位与海岸线
  // 保证互相对齐（生成脚本与经纬度取值见 BALANCE.md 对应轮次说明）
  const CHINA_LAND_PATH = "M25.84,94.84 L25.39,94.15 L24.54,94.37 L23.74,92.92 L23.1,92.67 L22.85,90.26 L23.34,88.99 L22.84,88.39 L22.29,88.63 L22.02,88.11 L21.37,88.32 L20.18,86.38 L19.32,87.34 L18.95,88.79 L18.29,89.33 L17.81,88.89 L17.39,90.09 L16.71,88.97 L16.44,89.87 L16.04,89.05 L15.37,90.51 L14.3,89.11 L13.58,90.83 L12.7,90.33 L12.32,91.4 L12.76,93.37 L12.9,96.19 L11.81,96.32 L11.47,93.74 L10.39,95.0 L9.57,95.04 L9.0,93.68 L8.95,92.44 L7.43,91.99 L8.09,88.16 L7.9,87.65 L6.74,87.09 L6.67,85.09 L6.35,83.8 L6.68,82.81 L5.37,82.86 L4.01,83.78 L4.32,82.32 L3.95,81.11 L4.05,79.8 L4.38,79.37 L4.55,77.61 L4.95,77.42 L5.23,76.14 L5.63,76.06 L6.3,74.79 L6.11,73.83 L6.37,73.3 L6.48,70.55 L6.29,66.93 L5.88,66.54 L5.55,67.04 L5.13,64.31 L4.69,63.32 L4.08,62.58 L3.5,63.96 L2.83,63.38 L2.83,7.46 L57.35,7.46 L57.35,11.37 L55.96,12.67 L55.21,14.11 L54.58,14.34 L54.52,14.98 L53.5,15.59 L53.38,14.72 L54.58,13.86 L54.47,13.35 L54.87,12.58 L53.73,12.59 L53.71,11.85 L54.24,11.42 L54.24,10.47 L54.84,9.99 L55.8,7.46 L52.52,7.46 L52.06,8.7 L49.78,10.9 L48.92,13.52 L47.49,14.04 L46.95,13.31 L46.58,13.48 L45.93,15.78 L46.14,17.0 L46.9,18.11 L48.83,18.76 L49.15,20.34 L48.86,22.04 L49.56,22.93 L50.56,22.84 L50.81,21.95 L51.71,20.69 L51.6,20.44 L52.63,19.72 L54.5,21.44 L55.18,21.51 L55.37,21.13 L55.96,21.69 L56.65,21.7 L56.19,23.25 L56.34,23.8 L55.97,24.33 L55.59,23.75 L55.11,23.75 L53.27,25.35 L52.76,25.25 L52.94,26.11 L52.55,26.26 L52.4,27.56 L51.88,27.91 L51.75,27.11 L51.44,27.23 L51.25,27.61 L51.66,28.23 L49.86,31.37 L49.31,33.46 L49.38,33.92 L51.62,36.1 L52.88,41.89 L52.85,43.52 L53.87,44.61 L54.0,45.62 L54.95,47.41 L54.97,47.93 L54.59,47.88 L53.89,47.21 L53.1,47.16 L52.15,46.08 L51.13,46.86 L52.56,46.64 L52.71,47.39 L54.54,49.69 L55.0,51.54 L54.04,52.13 L52.78,54.13 L52.0,53.98 L51.47,54.65 L52.09,54.37 L52.39,55.15 L53.7,54.37 L54.58,55.86 L55.42,56.36 L54.22,58.14 L55.02,57.47 L55.19,58.1 L55.08,59.74 L54.66,59.18 L54.09,59.76 L54.58,60.58 L54.29,60.68 L54.55,61.05 L54.15,62.02 L54.43,63.62 L53.73,63.95 L53.46,63.46 L53.07,64.79 L52.63,64.92 L52.8,65.47 L52.29,66.9 L52.33,67.67 L51.64,69.12 L51.24,71.08 L50.81,71.36 L50.69,70.27 L50.45,70.81 L50.2,70.55 L50.81,72.63 L49.93,73.91 L49.25,73.61 L49.66,74.4 L50.26,74.15 L50.09,76.05 L50.27,76.97 L49.34,76.7 L49.56,77.7 L48.92,77.81 L48.77,79.1 L48.2,79.52 L48.37,79.93 L48.24,80.51 L47.05,80.48 L46.88,81.15 L46.54,81.18 L46.98,82.23 L46.08,84.12 L45.75,84.1 L45.54,85.26 L45.38,84.68 L44.94,85.31 L44.58,84.99 L44.48,85.88 L43.99,86.34 L44.14,86.69 L43.8,87.14 L43.66,88.21 L43.2,88.05 L42.36,88.88 L41.92,88.64 L41.62,89.26 L40.99,88.81 L40.27,89.73 L39.84,89.09 L39.64,90.14 L39.19,89.84 L38.51,90.21 L37.68,88.61 L37.68,87.39 L37.47,87.5 L37.07,88.37 L37.54,89.83 L37.53,91.53 L36.7,92.22 L36.57,91.62 L36.28,93.0 L35.98,92.82 L35.51,93.6 L35.04,92.67 L34.92,93.76 L34.17,93.26 L33.45,94.6 L32.22,94.81 L31.28,96.18 L30.95,95.62 L30.46,97.17 L29.44,97.17 L29.94,94.96 L29.44,94.75 L29.18,93.99 L29.13,94.7 L28.31,95.21 L28.21,94.45 L27.52,94.27 L27.14,93.02 L26.9,93.0 L26.95,94.25 L26.58,93.98 L26.41,94.6 L25.84,94.84 Z";
  const JAPAN_HONSHU_PATH = "M95.58,3.44 L96.05,3.29 L96.0,6.43 L96.76,8.42 L97.17,10.71 L97.14,12.38 L96.98,13.85 L96.47,14.47 L96.24,15.45 L96.07,17.1 L95.32,17.4 L95.01,18.28 L95.1,23.03 L94.53,24.79 L94.2,27.09 L94.83,29.42 L93.96,30.41 L93.74,31.92 L92.67,33.15 L92.63,31.4 L93.2,30.06 L92.65,29.73 L92.26,30.88 L92.46,31.6 L92.32,32.07 L91.89,31.39 L91.42,31.48 L91.08,33.5 L90.56,34.51 L90.49,32.87 L90.7,32.64 L90.31,32.19 L90.01,32.37 L89.2,34.62 L87.84,34.3 L86.83,34.68 L87.28,33.8 L86.63,33.52 L86.52,34.1 L86.49,32.6 L86.29,32.53 L85.73,34.24 L86.45,35.36 L86.4,35.87 L85.3,36.55 L84.43,39.37 L83.97,39.72 L83.46,39.41 L82.78,37.33 L82.72,36.04 L83.38,34.52 L82.6,34.46 L81.97,33.84 L80.93,34.07 L80.35,34.94 L78.62,35.97 L77.6,36.23 L76.88,35.87 L76.53,38.1 L75.68,37.12 L73.95,37.48 L73.89,36.15 L74.13,35.55 L74.87,35.46 L78.15,30.41 L80.12,30.48 L82.88,29.33 L83.2,30.34 L83.94,30.44 L84.41,29.97 L84.81,29.23 L84.75,27.62 L86.07,24.74 L86.12,22.65 L86.38,21.8 L87.38,21.16 L87.41,21.55 L86.49,23.02 L86.74,24.31 L87.22,24.69 L87.78,23.78 L89.47,22.56 L90.66,19.67 L91.66,18.51 L92.58,14.9 L93.13,11.48 L92.99,10.42 L92.46,10.12 L93.02,8.56 L92.93,6.66 L93.53,6.03 L93.8,4.1 L94.31,4.26 L94.57,5.94 L94.96,5.43 L95.34,5.7 L95.61,4.21 L94.67,4.51 L94.68,3.99 L94.96,2.83 L95.58,3.44 Z";
  const JAPAN_KYUSHU_PATH = "M74.49,39.19 L74.89,39.33 L75.35,38.96 L75.58,39.18 L75.61,39.65 L75.25,40.7 L76.0,40.79 L75.9,41.42 L76.23,42.5 L75.51,44.42 L74.83,49.3 L74.27,49.15 L74.33,49.99 L73.47,51.1 L73.69,49.92 L73.5,48.51 L73.7,48.3 L73.65,47.91 L73.4,47.86 L73.19,48.57 L73.16,49.31 L73.38,49.93 L73.26,50.34 L72.45,49.82 L72.34,49.28 L72.65,49.09 L72.7,48.39 L72.42,47.62 L72.44,46.14 L72.85,45.55 L73.37,43.71 L73.07,43.54 L73.18,42.73 L72.83,41.53 L72.52,41.15 L72.29,41.48 L72.4,42.64 L72.71,42.64 L72.74,43.33 L72.54,43.45 L72.14,43.01 L71.54,43.93 L71.66,43.23 L71.38,42.54 L71.35,41.68 L71.67,42.45 L72.01,42.64 L71.81,41.85 L71.14,40.88 L71.21,40.38 L71.7,40.48 L71.66,39.95 L72.79,39.04 L73.04,38.12 L73.53,37.69 L74.02,37.95 L74.49,39.19 Z";
  const JAPAN_SHIKOKU_PATH = "M81.16,36.18 L81.75,36.32 L81.83,38.06 L81.96,38.19 L81.2,39.16 L80.8,40.83 L80.33,39.9 L79.64,39.61 L78.92,40.3 L78.27,42.68 L77.91,43.1 L77.57,43.05 L77.71,42.41 L77.26,42.35 L77.12,41.69 L77.29,40.61 L77.07,40.44 L77.09,39.98 L76.29,40.4 L77.57,38.79 L77.86,37.39 L78.18,36.92 L78.6,37.7 L79.54,37.28 L79.67,36.74 L79.58,36.23 L80.31,35.76 L80.57,35.71 L81.16,36.18 Z";
  const JAPAN_TSUSHIMA_PATH = "M70.74,35.73 L70.7,35.96 L70.49,35.66 L70.62,34.96 L70.61,34.57 L70.88,34.21 L70.94,34.37 L70.93,34.87 L70.73,35.45 L70.74,35.73 Z";
  // 长江/黄河：按大致真实流经路线取关键点连线，只为增添地图的真实可信度，不追求逐水文精度
  const YANGTZE_PATH = "M16.46,58.06 L22.75,57.83 L30.72,52.54 L34.7,54.15 L39.11,53.23 L41.83,57.14 L44.77,52.54 L47.29,49.32 L48.54,46.28 L51.69,47.02 L53.79,49.32";
  const YELLOW_RIVER_PATH = "M16.46,28.16 L20.65,21.26 L24.85,16.2 L29.67,12.06 L33.86,13.44 L35.54,18.96 L31.98,33.22 L33.03,34.14 L35.23,34.37 L37.64,33.45 L39.21,32.76 L41.62,26.78 L44.35,23.56 L46.87,21.26 L49.17,20.34";
